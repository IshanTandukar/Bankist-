...
for (const acc of accounts) {
  if (acc.owner === 'Jessica Davis') account22.push(acc);
  }
  ...
  const diceRandom = Array.from({length: 100}, () => diceRoll[Math.floor(Math.random() * diceRoll.length)]);
